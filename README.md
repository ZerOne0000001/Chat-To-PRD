...
完整的版本演进历史与详细更新内容，请参阅 `changelogs` 目录：
- [v1.2.0 近期更新 - PRD生成排版重构与防漏强化](changelogs/v1.2.0.md)
- [v1.1.0 历史更新 - 核心工作流重构与交互式 PRD 增强](changelogs/v1.1.0.md)
