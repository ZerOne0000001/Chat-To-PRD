...
<font color="red">**🚨 【准入前置条件】**</font>
<font color="red">用户已通过企业微信静默登录，否则拦截重定向至鉴权页。</font>

<font color="red">**⚠️ 【全局异常兜底】**</font>
<font color="red">若获取用户餐补余额接口失败，餐补区域展示为 `￥--`，提供“点击重试”按钮，**绝不阻塞**下方菜品列表的正常浏览与下单。</font>
...
---
**🚨 【准入前置条件】**
必须携带有效的选中商品数据（`sku_list`）且合计金额 > 0 方可进入，否则强阻断并返回首页。
---
